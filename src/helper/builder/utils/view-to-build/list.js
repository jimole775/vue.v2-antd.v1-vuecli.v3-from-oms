...
export default function list ({ columns, searchor }) {
  return {
    columns: columnsViewToBuild(columns),
    searchor: searchorViewToBuild(searchor)
  }
}

function columnsViewToBuild (originColumns = []) {
...
function searchorViewToBuild (
  originFormItems = [],
  fields = ['originProps', 'nodes', 'configType', 'showOnNodes', 'showOnRadios', 'editOnNodes', 'editOnRoles', 'showOnEnv']
) {
